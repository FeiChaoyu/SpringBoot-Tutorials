package com.feichaoyu.kafka.admin;
...
public class AdminDemo {
    ...
    public final static String TOPIC_NAME = "fcy-topic";
...
//        ListTopicsResult listTopicsResult = adminClient.listTopics();
    ...
    public static AdminClient adminClient() {
        ...
        properties.setProperty(AdminClientConfig.BOOTSTRAP_SERVERS_CONFIG, "172.20.10.3:9092");
